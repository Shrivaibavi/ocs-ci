"""
This file contains the deployment, testcases and teardown for openshift-logging
"""
import pytest
import logging
...
def test_fixture(request):
    ...
    * The setup will deploy openshift-logging on the cluster
    ...
    * The teardown will uninstall the openshift-logging from the cluster
    ...
    # Deploys Elastic-search operator
    ...
    # Deploys cluster-logging operator
    ...
    # Creates instance for openshift-logging
    ...
    # Checks the health of the openshift-logging cluster
...
class TestLogging_in_EFK_stack(E2ETest):
    """
    The class contains testcases related to the openshift-logging
    """
